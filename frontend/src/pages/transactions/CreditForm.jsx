    ...
    <div className="page-container">
      ...
      <div className="form-card glass-card">
        ...
        <form onSubmit={handleSubmit}>
          <FormInput label="Account Number" name="to_account" type="number" value={form.to_account} onChange={handleChange} required placeholder="Enter 12-digit account number" />
